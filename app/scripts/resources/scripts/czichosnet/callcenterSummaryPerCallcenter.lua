...
callcenter_uuid = "fc02bca3-ce6f-4795-a332-2280e783ba0a";
email = argv[2];
startDate = argv[3];
...
local file2 = assert(io.open("/opt/callcenterevaluation/AGENTS-"..callcenter_name .."-TIME-" ..  os.date('%d.%m.%Y',evaluationTime) ..".csv","w+"))
